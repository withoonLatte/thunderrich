    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-slate-50 via-indigo-50/20 to-slate-100 text-center overflow-y-auto scrollbar-none relative">
      ...
      <div className="w-full max-w-sm z-10 my-8 space-y-8">
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="w-24 h-24 bg-gradient-to-br from-sky-400 via-blue-500 to-pink-500 rounded-3xl mx-auto flex items-center justify-center shadow-2xl shadow-blue-500/25 transform rotate-12 hover:rotate-6 transition-all duration-300">
        ...
        {/* Login Form Container with Glassmorphism and Elegant Blue-to-Pink Gradient Border */}
        <motion.div 
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.1, duration: 0.5 }}
          className="bg-gradient-to-br from-sky-400 via-blue-500 to-pink-500 p-[2px] rounded-[2.6rem] shadow-2xl shadow-blue-500/10"
        >
          <div className="bg-white/95 backdrop-blur-2xl px-6 py-8 rounded-[2.5rem] text-left space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-200/80 rounded-2xl py-4 pl-12 pr-4 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-sky-400 focus:ring-4 focus:ring-sky-400/5 transition-all font-bold text-base"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-200/80 rounded-2xl py-4 pl-12 pr-12 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-sky-400 focus:ring-4 focus:ring-sky-400/5 transition-all font-bold text-base tracking-widest"
                    required
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-sky-400 via-blue-500 to-pink-500 text-white py-4.5 rounded-2xl flex items-center justify-center gap-2 hover:brightness-110 transition-all font-black text-base uppercase tracking-wider shadow-lg shadow-blue-500/20 active:scale-[0.98] disabled:opacity-50 mt-2"
              >
                {loading ? (
